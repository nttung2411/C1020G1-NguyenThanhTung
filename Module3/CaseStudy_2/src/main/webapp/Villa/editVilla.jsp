                ...
                <form method="post">
                    ...
                    <table cellpadding="5">
                        <tr>
                            <th>Tên Villa:</th>
                            <td>
                                <input type="text" name="name" size="45" value="${villa.nameVilla}"/>
                            </td>
                        </tr>
                        <tr>
                        <tr>
                            ...
                            <td>
                                <select name="standard_room">
                                    ...
                                    <option value="Superỉor">Superỉor</option>
                        ...
                        <tr>
                            <th>Diện tích:</th>
                            <td>
                                <input type="text" name="area" size="45" value="${villa.area}"/>
                            </td>
                        </tr>
                        <tr>
                            <th>Diện tích hồ bơi:</th>
                            <td>
                                <input type="text" name="area_pool" size="45" value="${villa.pool_area}"/>
                            </td>
                        </tr>
                        <tr>
                            <th>Số tầng:</th>
                            <td>
                                <input type="text" name="floor" size="45" value="${villa.floor}"/>
                            </td>
                        </tr>
                        <tr>
                            <th>Sức chứa tối đa:</th>
                            <td>
                                <input type="text" name="max_people" size="45" value="${villa.max_people}"/>
                            </td>
                        </tr>
                        <tr>
                            <th>Giá dịch vụ:</th>
                            <td>
                                <input type="text" name="cost" size="45" value="${villa.cost}"/>
                            </td>
                        </tr>
                        <tr>
