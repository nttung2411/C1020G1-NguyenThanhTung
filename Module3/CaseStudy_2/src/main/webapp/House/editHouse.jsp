                ...
                <form method="post">
                    ...
                    <table cellpadding="5">
                        <tr>
                            <th>Tên House:</th>
                            <td>
                                <input type="text" name="name" size="45" value="${house.nameHouse}"/>
                            </td>
                        </tr>
                        <tr>
                        <tr>
                        ...
                        <tr>
                            <th>Diện tích:</th>
                            <td>
                                <input type="text" name="area" size="45" value="${house.area}"/>
                            </td>
                        </tr>
                        <tr>
                            <th>Số tầng:</th>
                            <td>
                                <input type="text" name="floor" size="45" values="${house.floor}"/>
                            </td>
                        </tr>
                        <tr>
                            <th>Sức chứa tối đa:</th>
                            <td>
                                <input type="text" name="max_people" size="45" value="${house.max_people}"/>
                            </td>
                        </tr>
                        <tr>
                            <th>Giá dịch vụ:</th>
                            <td>
                                <input type="text" name="cost" size="45" value="${house.cost}"/>
                            </td>
                        </tr>
                        <tr>
