                ...
                <form method="post">
                    ...
                    <table cellpadding="5">
                        <tr>
                            ...
                            <td>
                                <input type="text" name="name" size="45" value="${customer.customer_name}"/>
                            </td>
                        </tr>
                        <tr>
                            <th>Loại khách:</th>
                        ...
                        <tr>
                            <th>Số CMND:</th>
                            <td>
                                <input type="text" name="CMND" size="45" value="${customer.customer_id_card}"/>
                            </td>
                        </tr>
                        <tr>
                            <th>Số điện thoại:</th>
                            <td>
                                <input type="text" name="phone" size="45" value="${customer.customer_phone}"/>
                            </td>
                        </tr>
                        <tr>
                            <th>Email đăng ký:</th>
                            <td>
                                <input type="text" name="email" size="45" value="${customer.customer_email}"/>
                            </td>
                        </tr>
                        <tr>
                            <th>Địa chỉ:</th>
                            <td>
                                <input type="text" name="address" size="45" value="${customer.customer_address}"/>
                            </td>
                        </tr>
                        <tr>
