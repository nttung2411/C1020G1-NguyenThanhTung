...
public class Customer {
    ...
    public Customer(int customer_type, String customer_name,
                    String customer_birthday, int customer_gender, String customer_phone,
    ...
    public Customer(String customer_id, int customer_type, String customer_name, String customer_birthday,
