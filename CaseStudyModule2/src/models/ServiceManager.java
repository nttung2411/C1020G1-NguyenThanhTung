    ...
    public static void addNewService() throws IOException, ClassNotFoundException {
        ...
        switch (inputNumberService) {
            ...
            case 1:
                ...
                List<String> checkIDVilla = FileUtils.readFile("src/data/Villa.csv");
                boolean flag;
                String idVilla;
                String nameVilla;
                double areaOfVilla;
                ...
                FileUtils.writeFile("src/data/Villa.csv", villa);
                addNewService();
                break;
            case 2:
                List<String> checkIDHouse = FileUtils.readFile("src/data/House.csv");
                ...
                House house = new House(idHouse, nameHouse, areaOfHouse, accompanyPeopleHouse, floorsOfHouse, typeOfRoomHouse, typeOfRentalHouse, priceHouse);
                FileUtils.writeFile("src/data/House.csv", house);
                addNewService();
                break;
            case 3:
                List<String> checkIDRoom = FileUtils.readFile("src/data/Room.csv");
                ...
                FileUtils.writeFile("src/data/Room.csv", room);
                addNewService();
                break;
            case 4:
